...
- [ ] Step 8: nine chaining commits landed (per Step 7 v4), chaining + no-dependency + rejection-scoped (5 categories) + dedup + cascading-failure + fully-dry-run + result-order-preserved + persistence-round-trip fixtures all passing, token delta measured
